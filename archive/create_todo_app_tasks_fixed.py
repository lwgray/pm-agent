#!/usr/bin/env python3
"""
Create Todo App tasks in Planka for testing PM Agent - Fixed version
"""
    ...
    try:
        ...
        async with client.connect() as conn:
            ...
            if not client.board_id:
                ...
                print("  1. python select_task_master_board.py")
            ...
            if not todo_list:
                todo_list = lists_data["lists"][0]  # Use first list
