...
for test_file in test_conversation_stream.py test_decision_visualizer.py test_health_monitor.py test_knowledge_graph.py test_visualization_integration.py test_ui_server_unit.py test_ui_server_api.py test_ui_server_integration.py; do
    echo ""
